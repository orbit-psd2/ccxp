      ...
      <div className={`max-w-7xl mx-auto px-4 py-4 ${
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-10">
            <a href="#" className="text-zinc-900 tracking-wider hover:text-orange-500 duration-300 font-faculty uppercase transition-colors font-semibold text-[18px]"><Link to='/'>Home</Link></a>

      ...
      <div className={`max-w-7xl mx-auto px-4 py-4 ${
        ...
        <div className="flex items-center justify-around">
          <div className="flex items-center space-x-2">
            <span className="md:text-[22px] font-bold text-zinc-800 max-sm:text-[17px] max-md:text-[22px] uppercase"><Link to='/'>CloudCon X Pulse'25</Link></span>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-10">
            ...
            <a href="#sponsors" className="text-zinc-800 hover:text-orange-400 font-outfit uppercase transition-colors font-semibold text-[18px]">Contact</a>
          </div>

...
export default function TRules2() {
  const rules = [
    "Teams must not use electronic devices during the event to maintain fairness",
    "Each round will have a time limit, late submissions will not be considered",
    "Respect the event's decorum and avoid sharing answers with other teams",
    "Clues will be provided as per the format; participants must not request additional hints",
    "Judging will be based on accuracy and speed of solving puzzles",

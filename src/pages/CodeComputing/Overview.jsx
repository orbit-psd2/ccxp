...
export default function TOverview3() {
  const formLink = "https://docs.google.com/forms/d/e/1FAIpQLSeHJpZwEb0wOoMIDmPzXATyWew0VigXL5z1Oosmm5G1sBP7yg/viewform";
    ...
    <div className="relative min-h-[80vh] flex items-center">
      ...
      <div className="relative z-10 container mx-auto px-6 py-[130px] pb-[191px] text-white">
        ...
        >
          ...
          Code-Computing: The Competitive Programming Challenge
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-2xl font-pridi">MLCP LAB 4</span>
              </div>
              <div className="flex items-center space-x-3">

...
export default function TRules2() {
  const rules = [
    "Participants must bring their own laptops with pre-installed design software (e.g., Photoshop, Illustrator, or Canva)",
    "All designs must be original, plagiarism will result in disqualification",
    "Internet usage is permitted only for gathering resources, not for copying designs",
    "Respect the time limit for submissions, as late entries will not be considered",
    "Teamwork and creativity are encouraged; maintain a positive and collaborative spirit",
    "Decisions by the panel of judges are final and must be respected",
  ];

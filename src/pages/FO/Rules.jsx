...
export default function TRules2() {
  const rules = [
    "Participants must bring their own controllers and gaming accessories if required",
    "Use of unfair game modifications, cheats, or exploits is strictly prohibited",
    "All matches will follow the official rules of FIFA EA Sports, as announced during the event",
    "Disruptive behavior or unsportsmanlike conduct will lead to disqualification",
    "Ensure your gaming setup is ready before the match to avoid delays",
    "Decisions by referees and organizers are final",
  ];

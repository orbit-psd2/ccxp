...
export default function TRules1() {
  const rules = [
    ...
    "Attendance will be taken at the start and end of the workshop",
    "Certificate will be provided only to those who attend the full workshop",
    "Installation guidelines will be shared prior to the workshop",
    "Participants should follow the code of conduct",

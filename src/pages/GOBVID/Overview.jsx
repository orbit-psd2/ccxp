...
export default function NTOverview5() {
  ...
  const formLink = "https://docs.google.com/forms/d/e/1FAIpQLSfL_0FnHnjWp89e0ykQt9Dc9-PskiZ2ag46FhydTt9MuFIXZA/viewform";
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                <span className="text-2xl font-medium mt-5 font-pridi">Registration Fee: ₹ 100 (Per Person)/-</span>
              </div>
            </div>
            ...
            <div className="space-y-9">
              ...
              <div>
                ...
                <ul className="space-y-2 text-xl font-pridi">
                  <li>Ms C Kudiyarasudevi,Asst. Prof/CSE</li>
                  <li>Ms S  Chandrakala,Asst. Prof/CSE</li>
                </ul>
              </div>
            </div>
          </div>

  ...
  return (
    <div className="relative min-h-[80vh] flex items-center">
      <div 
        ...
        style={{
          backgroundImage: 'url("https://images.pexels.com/photos/221304/pexels-photo-221304.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1")',
        }}
      >
            ...
            <div className="space-y-9">
              ...
              <div>
                ...
                <ul className="space-y-2 text-xl font-pridi">
                  <li>Dr.Tamilselvi, Prof/CSE</li>
                  <li>Mrs. Ramaprabha, Asst.Prof/CSE</li>
                </ul>
              </div>
            </div>
          </div>

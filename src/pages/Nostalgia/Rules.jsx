...
export default function TRules2() {
  const rules = [
    "All games will follow their traditional rules as explained before each round",
    "Teams or individuals must play fairly; any misconduct will lead to disqualification",
    "Timely participation in each round is mandatory to ensure smooth event flow",
    "Participants must respect other players and maintain a positive attitude",
    "Decisions by referees or event coordinators are final",
  ];

...
export default function NTOverview3() {
  const [showForm , setShowForm] = useState(false)

  const formLink = "https://docs.google.com/forms/d/e/1FAIpQLSdDV2Qpvawgj37Qszcga5tcA3YD_wESBnHBiTah_iYNMhswdw/viewform?embedded=true";
  ...
  return (
    <div className="relative min-h-[80vh] flex items-center">
      <div 
        ...
        style={{
          backgroundImage: 'url("https://images.pexels.com/photos/2251206/pexels-photo-2251206.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1")',
        }}
      >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-2xl font-pridi uppercase">HI-TECH HALL</span>
              </div>
              <div className="flex items-center space-x-3">
            ...
            <div className="space-y-9">
              <div>
                ...
                <ul className="space-y-2">
                  <li className="flex items-center font-pridi text-xl">
                    ...
                    T Neha Chowdary - 7675975396
                  </li>
                  <li className="flex items-center font-pridi text-xl">
                    <Phone className="w-5 h-5 mr-2 text-blue-400" />
                    Siva Karthik - 9059526299
                  </li>
                  <li className="flex items-center font-pridi text-xl">
                    <Phone className="w-5 h-5 mr-2 text-blue-400" />
                    K S Manoj Kavin - 6383155200
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-xl font-pridi">
                  <li>Dr  G Gangadevi ,Asst. Prof/CSE</li>
                  <li>Dr C Saravanan,Asst. Prof/CSE</li>
                </ul>
              </div>
            </div>
          </div>

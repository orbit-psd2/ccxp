...
export default function TRules2() {
  const rules = [
    "Teams must consist of the specified number of members as mentioned during registration",
    "Internet usage is not allowed during the event to maintain fairness",
    "Teams must stay within the given time frame for each round",
    "Respect the decorum of the event and avoid disruptive behavior",
    "Only one answer submission is allowed per round; ensure clarity before submitting",
